...
function render(data) {
  ...
  $("electrs-service").textContent = serviceLabel(services.electrs);
...
// Set correct mempool explorer URL (works over network)
const mempoolLink = $("mempool-link");
if (mempoolLink) {
  mempoolLink.href = `http://${window.location.hostname}:8080`;
}
